...
import com.lucas.restspringboot.mocks.MockPerson;
...
public class ObjectMapperTest {
    ...
    public void parseEntityToDTOTest() {
        PersonDTO output = ObjectMapper.parseObject(inputObject.mockEntity(1), PersonDTO.class);
        ...
        assertEquals("Addres Test1", output.getAddress());
